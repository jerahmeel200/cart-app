...
const articles = [
  ...
  {
    image: image5,
    desc: 'AirPods Max | Apple M3 Max | 1TB',
    price: '₦1,099,000.00',
  },
  {
    image: image15,
    ...
    {articles.map((article, index) => (
      ...
      >
        <div>
          ...
          />
          <div>
          <h2 className="text-[7.22px] leading-[11.88px] sm:text-[22px] sm:leading-[36.18px] md:text-[20px] md:leading-[36.18px] font-semibold ">{article.desc}</h2>
